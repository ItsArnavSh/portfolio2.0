...
<p class = "text-5xl mb-5 anta-regular">Trillingo</p>
</div>
<div class = "flex flex-row justify-center items-center ">
    
<div class = " p-10 flex flex-col items-end text-3xl prompt-regular">
    <p class = "mb-4">Solving the Problem</p>
    <p class = "mb-4">in <b>3 Algorithms</b>, in <b>3 Languages</b>, Every <b>3 Days</b></p>
...
<div class = "justify-start">
    <img alt = "Computer" src = "/images/programming.png">
</div>
</div>
</div> 